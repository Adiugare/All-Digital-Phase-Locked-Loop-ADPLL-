...
REM
REM Generated by Vivado on Thu Nov 27 23:11:10 +0530 2025
...
echo "xvlog --incr --relax -prj digital_pll_tb_vlog.prj"
call xvlog  --incr --relax -prj digital_pll_tb_vlog.prj -log xvlog.log
